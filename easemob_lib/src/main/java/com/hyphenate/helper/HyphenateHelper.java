...
public class HyphenateHelper {
    ...
    public static String APP_KEY = "1463190627068041#kefuchannelapp72541";
//    public static String APP_KEY = "1108190619222101#megamart";
//    private static String APP_KEY = "1101190525046322#zrjm";
...
//        options.setAcceptInvitationAlways(false);
     ...
     * @param pwd      环信用户密码
     */
    public static void callServiceIM(final Activity mContext, final String user_id, String pwd, final String user_avatar) {
        //检查登录状态
     ...
     * @param user_id
     */
    public static void callChatIM(Activity mContext, Class<?> cls, String user_id) {
        //已经登录，可以直接进入会话界面
