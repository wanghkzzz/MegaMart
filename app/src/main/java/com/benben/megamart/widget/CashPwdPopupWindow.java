...
import com.benben.megamart.securitykeyboard.KeyboardType;
import com.benben.megamart.securitykeyboard.SecurityConfigure;
import com.benben.megamart.securitykeyboard.SecurityKeyboard;
...
public class CashPwdPopupWindow extends PopupWindow {
    ...
    public CashPwdPopupWindow(Activity activity, CashInterface cashInterface,TextView tvShowPopupWindow) {
        super(activity);
