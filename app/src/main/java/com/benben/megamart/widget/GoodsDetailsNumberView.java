 ...
 * 商品详情页 自定义增加购买数量的控件
 */
public class GoodsDetailsNumberView extends RelativeLayout {
    ...
    public GoodsDetailsNumberView(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.context = context;

        LayoutInflater.from(context).inflate(R.layout.layout_goods_details_number_view, this, true);
            ...
            public void onClick(View v) {
                ...
                if (editable) {
                    ...
                    if (onNumberChagneListener != null) {
                        onNumberChagneListener.onChange(true);
                    }
                }
            }
        });
        btnReduce.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                if (editable) {
                    ...
                    if (onNumberChagneListener != null) {
                        onNumberChagneListener.onChange(false);
                    }
                }
            }
        });
