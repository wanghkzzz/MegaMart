 ...
 */
public class HomeBlockGoodsListAdapter extends AFinalRecyclerViewAdapter<HomeBlockGoodsListBean> {


    private Activity mActivity;
    public HomeBlockGoodsListAdapter(Context ctx) {
        super(ctx);
    ...
    public class HomeCommonGoodsListViewHoler extends BaseRecyclerViewHolder {
        ...
        private void setContent(HomeBlockGoodsListBean blockGoodsListBean, int position) {
            ...
            ImageUtils.getCircularPic(blockGoodsListBean.getGoods_pic(), ivGoodsThumb, m_Context, 10,R.drawable.image_placeholder);

            tvGoodsName.setText(blockGoodsListBean.getGoods_name());
            tvGoodsPrice.setText(m_Context.getString(R.string.goods_price, String.valueOf(blockGoodsListBean.getGoods_price())));
            ...
            rootView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    intent.putExtra(Constants.EXTRA_KEY_GOODS_ID, String.valueOf(blockGoodsListBean.getGoods_id()));
            ...
            ivAddCart.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    GoodsDetailsActivity.addCart(mActivity, blockGoodsListBean.getGoods_id(), MegaMartApplication.mPreferenceProvider.getUId(), 0, 1);
                }
            });
        }
    }
